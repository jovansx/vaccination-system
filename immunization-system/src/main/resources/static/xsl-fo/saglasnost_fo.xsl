...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    xmlns:s="http://www.akatsuki.org/saglasnost_za_imunizaciju"
            ...
            <fo:page-sequence master-reference="saglasnost">
                ...
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block font-family="sans-serif" font-size="12px" padding="5px" font-weight="bold">
                        Lekar mi je objasnio prednosti i rizike od sprovodjenja aktivne/pasivne imunizacije navedenim imunoloskim lekom.
                    </fo:block>
                    ...
                    <xsl:if test="//s:evidencija_o_vakcinaciji">
                        <fo:block font-family="sans-serif" font-size="16px" padding="5px" text-align="center">EVIDENCIJA O VAKCINACIJI PROTIV COVID-19</fo:block>
                        <fo:block font-family="sans-serif" font-size="12px" margin-bottom="5px" text-align="center">(popunjava zdravstevni radnik)</fo:block>
                        <fo:block font-family="sans-serif" font-size="12px" margin-bottom="5px">
                            Zdravstvena ustanova
                            <fo:inline font-weight="bold"><xsl:value-of select="concat(' ', //s:zdravstvena_ustanova, ' ')"/></fo:inline>
                            Vakcinacijski punkt
                            <fo:inline font-weight="bold"><xsl:value-of select="concat(' ', //s:vakcinacijski_punkt)"/></fo:inline>
                        </fo:block>
                        <fo:block font-family="sans-serif" font-size="12px" margin-bottom="5px">
                            Ime, prezime, faksimil i br. telefona lekara:
                            <fo:inline font-weight="bold">
                                <xsl:value-of select="concat(' ', //s:lekar/s:ime, ', ', //s:lekar/s:prezime, ', ', //s:lekar/s:telefon)"/>
                            </fo:inline>
                        </fo:block>
                        <fo:block font-family="sans-serif" font-size="12px" margin-bottom="5px">
                            Pre davanja vakcine pregledati osobu i upoznati je sa koristima i o mogucim nezeljenim reakcijama posle vakcinacije. Obavezno upisati svaku datu
                            vakcinu i sve trazene podatke u ovaj obrazac i podatke uneti u licni karton o izvrsenim imunizacijama i zdravstveni karton.
                        </fo:block>
                                    ...
                                    <xsl:for-each select="//s:vakcine/s:vakcina">
                                        <fo:table-row border="1px solid darkgrey">
                                            <fo:table-cell padding="2px">
                                                <fo:block><xsl:value-of select="s:naziv" /></fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell padding="2px">
                                                <fo:block><xsl:value-of select="s:datum_izdavanja" /></fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell padding="2px">
                                                <fo:block><xsl:value-of select="s:nacin_davanja" /></fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell padding="2px">
                                                <fo:block><xsl:value-of select="s:ekstremitet" /></fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell padding="2px">
                                                <fo:block><xsl:value-of select="s:serija" /></fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell padding="2px">
                                                <fo:block><xsl:value-of select="s:proizvodjac" /></fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell padding="2px">
                                                <fo:block><xsl:value-of select="s:nezeljena_reakcija" /></fo:block>
                                            </fo:table-cell>
                                        </fo:table-row>
                                    </xsl:for-each>
                                </fo:table-body>
