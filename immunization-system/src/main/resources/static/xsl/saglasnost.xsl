            ...
            <body>
                ...
                <p class="indent-paragraph">
                    ...
                    <xsl:if test="//s:drzavljanstvo/s:srpsko">
                        <b><xsl:value-of select="concat(' ', //s:drzavljanstvo/s:srpsko/s:id_broj)"/></b>
                    </xsl:if>
                </p>
                <p class="indent-paragraph" style="margin-left: 21vw;">
                    2) Strano drz.
                    <xsl:if test="//s:drzavljanstvo/s:strano">
                        <b><xsl:value-of select="concat(' ', //s:drzavljanstvo/s:strano/s:naziv, ' ')"/></b>
                    </xsl:if>
                    | Br. pasosa
                    <xsl:if test="//s:drzavljanstvo/s:strano">
                        <b><xsl:value-of select="concat(' ', //s:drzavljanstvo/s:strano/s:id_broj, ' ')"/></b>
                    </xsl:if>
                </p>
                <p class="indent-paragraph">
                    <b>Prezime</b>
                ...
                <p class="indent-paragraph" style="border-bottom: 3px dashed black; margin-right: 10vw;">
                    <b>Lekar mi je objasnio prednosti i rizike od sprovodjenja aktivne/pasivne imunizacije navedenim imunoloskim lekom.</b>
                </p>
                <xsl:if test="//s:evidencija_o_vakcinaciji">
                    ...
                    <p class="indent-paragraph">
                        ...
                        <b><xsl:value-of select="concat(' ', //s:zdravstvena_ustanova, ' ')"/></b>
                        Vakcinacijski punkt
                        <b><xsl:value-of select="concat(' ', //s:vakcinacijski_punkt)"/></b>
                    </p>
                    <p class="indent-paragraph">
                        Ime, prezime, faksimil i br. telefona lekara:
                        <b><xsl:value-of select="concat(' ', //s:lekar/s:ime, ', ', //s:lekar/s:prezime, ', ', //s:lekar/s:telefon)"/></b>
                    </p>
                    ...
                    <table style="width: 80vw; margin: 20px 10vw 20px 10vw;">
                        ...
                        <xsl:for-each select="//s:vakcine/s:vakcina">
                            <tr>
                                <td><xsl:value-of select="s:naziv" /></td>
                                <td><xsl:value-of select="s:datum_izdavanja" /></td>
                                <td><xsl:value-of select="s:nacin_davanja" /></td>
                                <td><xsl:value-of select="s:ekstremitet" /></td>
                                <td><xsl:value-of select="s:serija" /></td>
                                <td><xsl:value-of select="s:proizvodjac" /></td>
                                <td><xsl:value-of select="s:nezeljena_reakcija" /></td>
                            </tr>
                        </xsl:for-each>
                    </table>
                    <p class="indent-paragraph">
